  ...
  return (
    <section className="pagina-contenido">
      ...
      <section className="tarjeta-panel">
        <h3>Lista de Reportes por Sucursal</h3>
        <p style={{ marginBottom: '15px', color: '#64748b' }}>Haz clic en un reporte para desplegar su auditoría detallada (Ventas y Stock).</p>
            ...
            return (
              <div key={p.id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                ...
                >
                  ...
                  <button 
                    style={{ background: isExpandido ? '#64748b' : '#2563eb', padding: '5px 10px', fontSize: '0.8rem' }}
                  >
